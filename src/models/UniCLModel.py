...
from models.MedImageInsight.ImageEncoder import build_image_encoder
from models.MedImageInsight.LangEncoder import build_lang_encoder
from models.MedImageInsight.LangEncoder import build_tokenizer
...
def build_unicl_model(config, **kwargs):
    ...
    if config['UNICL_MODEL']['LOAD_PRETRAINED']:
        ...
        from MedImageInsight.Distributed.Utils import is_valid_url, download_file
